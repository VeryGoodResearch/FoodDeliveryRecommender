...
class BaseRunner(object):
	...
	def parse_runner_args(parser):
		...
		parser.add_argument('--eval_batch_size_dev', type=int, default=0,
							help='Batch size during testing for validation set.')
	...
	def __init__(self, args):
		...
		self.eval_batch_size_dev = args.eval_batch_size_dev if args.eval_batch_size_dev>0 else self.eval_batch_size
		self.l2 = args.l2
